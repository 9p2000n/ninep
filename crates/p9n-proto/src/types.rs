...
impl MsgType {
    ...
    pub fn name(self) -> &'static str {
        match self {
            // base
            Self::Tlerror => "Tlerror",
            Self::Rlerror => "Rlerror",
            Self::Tstatfs => "Tstatfs",
            Self::Rstatfs => "Rstatfs",
            Self::Tlopen => "Tlopen",
            Self::Rlopen => "Rlopen",
            ...
            Self::Txattrwalk => "Txattrwalk",
            Self::Rxattrwalk => "Rxattrwalk",
            Self::Txattrcreate => "Txattrcreate",
            Self::Rxattrcreate => "Rxattrcreate",
            ...
            Self::Tlock => "Tlock",
            Self::Rlock => "Rlock",
            Self::Tgetlock => "Tgetlock",
            Self::Rgetlock => "Rgetlock",
            Self::Tlink => "Tlink",
            Self::Rlink => "Rlink",
            Self::Tmkdir => "Tmkdir",
            Self::Rmkdir => "Rmkdir",
            ...
            Self::Tcaps => "Tcaps",
            Self::Rcaps => "Rcaps",
            Self::Tstartls => "Tstartls",
            Self::Rstartls => "Rstartls",
            Self::Tcapgrant => "Tcapgrant",
            Self::Rcapgrant => "Rcapgrant",
            Self::Tcapuse => "Tcapuse",
            Self::Rcapuse => "Rcapuse",
            Self::Tauditctl => "Tauditctl",
            Self::Rauditctl => "Rauditctl",
            Self::TstartlsSpiffe => "Tstartls_spiffe",
            Self::RstartlsSpiffe => "Rstartls_spiffe",
            Self::Tfetchbundle => "Tfetchbundle",
            Self::Rfetchbundle => "Rfetchbundle",
            Self::Tspiffeverify => "Tspiffeverify",
            Self::Rspiffeverify => "Rspiffeverify",
            Self::Tcxlmap => "Tcxlmap",
            Self::Rcxlmap => "Rcxlmap",
            Self::Tcxlcoherence => "Tcxlcoherence",
            Self::Rcxlcoherence => "Rcxlcoherence",
            Self::Trdmatoken => "Trdmatoken",
            Self::Rrdmatoken => "Rrdmatoken",
            Self::Trdmanotify => "Trdmanotify",
            Self::Rrdmanotify => "Rrdmanotify",
            Self::Tquicstream => "Tquicstream",
            Self::Rquicstream => "Rquicstream",
            Self::Tcompound => "Tcompound",
            Self::Rcompound => "Rcompound",
            Self::Tcompress => "Tcompress",
            Self::Rcompress => "Rcompress",
            Self::Tcopyrange => "Tcopyrange",
            Self::Rcopyrange => "Rcopyrange",
            Self::Tallocate => "Tallocate",
            Self::Rallocate => "Rallocate",
            Self::Tseekhole => "Tseekhole",
            Self::Rseekhole => "Rseekhole",
            Self::Tmmaphint => "Tmmaphint",
            Self::Rmmaphint => "Rmmaphint",
            Self::Twatch => "Twatch",
            Self::Rwatch => "Rwatch",
            Self::Tunwatch => "Tunwatch",
            Self::Runwatch => "Runwatch",
            Self::Tnotify => "Tnotify",
            Self::Rnotify => "Rnotify",
            Self::Tgetacl => "Tgetacl",
            Self::Rgetacl => "Rgetacl",
            Self::Tsetacl => "Tsetacl",
            Self::Rsetacl => "Rsetacl",
            Self::Tsnapshot => "Tsnapshot",
            Self::Rsnapshot => "Rsnapshot",
            Self::Tclone => "Tclone",
            Self::Rclone => "Rclone",
            Self::Txattrget => "Txattrget",
            Self::Rxattrget => "Rxattrget",
            Self::Txattrset => "Txattrset",
            Self::Rxattrset => "Rxattrset",
            Self::Txattrlist => "Txattrlist",
            Self::Rxattrlist => "Rxattrlist",
            Self::Tlease => "Tlease",
            Self::Rlease => "Rlease",
            Self::Tleaserenew => "Tleaserenew",
            Self::Rleaserenew => "Rleaserenew",
            Self::Tleasebreak => "Tleasebreak",
            Self::Rleasebreak => "Rleasebreak",
            Self::Tleaseack => "Tleaseack",
            Self::Rleaseack => "Rleaseack",
            Self::Tsession => "Tsession",
            Self::Rsession => "Rsession",
            Self::Tconsistency => "Tconsistency",
            Self::Rconsistency => "Rconsistency",
            Self::Ttopology => "Ttopology",
            Self::Rtopology => "Rtopology",
            Self::Ttraceattr => "Ttraceattr",
            Self::Rtraceattr => "Rtraceattr",
            Self::Thealth => "Thealth",
            Self::Rhealth => "Rhealth",
            Self::Tserverstats => "Tserverstats",
            Self::Rserverstats => "Rserverstats",
            Self::Tgetquota => "Tgetquota",
            Self::Rgetquota => "Rgetquota",
            Self::Tsetquota => "Tsetquota",
            Self::Rsetquota => "Rsetquota",
            Self::Tratelimit => "Tratelimit",
            Self::Rratelimit => "Rratelimit",
            Self::Tasync => "Tasync",
            Self::Rasync => "Rasync",
            Self::Tpoll => "Tpoll",
            Self::Rpoll => "Rpoll",
            Self::Tstreamopen => "Tstreamopen",
            Self::Rstreamopen => "Rstreamopen",
            Self::Tstreamdata => "Tstreamdata",
            Self::Rstreamdata => "Rstreamdata",
            Self::Tstreamclose => "Tstreamclose",
            Self::Rstreamclose => "Rstreamclose",
